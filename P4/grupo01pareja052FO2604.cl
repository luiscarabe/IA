(defpackage :grupo01pareja052FO2604 
  (:use :common-lisp :mancala)      
  (:export :heuristica :*alias*))

(in-package grupo01pareja052FO2604)
...
(defun heuristica (estado)
  (if (juego-terminado-p estado)
      (if (> (cuenta-fichas (estado-tablero estado) (estado-lado-sgte-jugador estado) 0)
        ...
        0) ; Si hemos perdido
  (valorar-Heur2 '(154 183 74 16 17 5) 0 (estado-tablero estado) (estado-lado-sgte-jugador estado))))

(defvar *alias* '|pero_es_una_excavadora|)
